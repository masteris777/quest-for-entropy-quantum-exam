...
Same arena as test 01. 'A fresh frame' means a new orthonormal triple of observer directions, drawn independently of anything measured. 'A fresh world' (W2) means a different turn operator U_S and a different initial state — a genuinely separate substrate, not a reseeding of the first one.
